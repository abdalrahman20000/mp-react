      ...
      <div className="w-full mx-2 flex flex-col justify-center items-center md:flex-row">
        ...
        <nav className="flex-col justify-center items-center space-x-4 mb-4 md:mb-0">
          <div className="flex justify-center items-center max-sm:flex-col">
            <Link to="/l" className="hover:text-dark-yellow-hover transition m-2">Home</Link>
            <Link to="/sessions" className="hover:text-dark-yellow-hover transition m-2">sessions</Link>
            <Link to="/subscription" className="hover:text-dark-yellow-hover transition m-2">subscription</Link>
